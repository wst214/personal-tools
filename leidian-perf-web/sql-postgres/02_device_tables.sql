-- PERF 低频设备 standard / biz 表（暂不分区，推荐存量约 1 万行）
-- 字段对齐 Flyway V5 / V6，schema 隔离在 perf
...
-- ============================================================
-- standard_ispd_pdu / biz_ispd_pdu_event（V6）
-- ============================================================
...
-- ============================================================
-- standard_surge_monitor / biz_surge_monitor_event（V6）
-- ============================================================
