...
PERF_SCENARIOS = [
    ...
    ("PERF-05-AGG", "多电场仪过程窗时间桶聚合（跨设备合成一条）"),
    ("PERF-05-AGG-MV", "过程窗分钟聚合（读物化视图）"),
    ("PERF-05-1MIN", "单电场仪1分钟窗秒级曲线查询"),
    ("PERF-06", "闪电事件时空统计查询"),
]
...
STAGE_SCALE_DESC = {
    ...
    "S4": "推荐存量档（当前不强制执行）",
    "S5": "压测加压档（大气1亿+过程150）",
    "S6": "加压扩展档（大气2亿+过程225+日历18月）",
    "S7": "200台×15天真1Hz（三层+其它S6量级）",
    "S8": "100台×30天真1Hz（三层+其它S7量级）",
    "S9": "500台×30天仅大气biz（std/raw无大气）",
}
