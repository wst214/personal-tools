...
信息整理章、案头推理章、古代守井人独自当值这类场景，细纲本身设计成一个人在场，"引入配角"这条不适用——硬塞一个新角色进来会违反细纲"不新增角色"的约束，也会打乱人物登场节奏（比如让本该第20章才出场的角色提前露面）。这类场景要压独白密度，有两个不新增角色也能用的技法：

1. **电话/远程咨询转对话**：把主角一段沉默的内心推理，拆成她打电话/发消息问一个无名无姓、纯功能性的旁人（"做法务的旧同学""开地产中介的旧相识"），对方给出几句专业角度的信息，主角自己再给出结论。对方不需要姓名和人设，只是一个信息来源的"声音"，不算新增角色，不会牵连后续人物登场安排。这个技法只拆开原本就要交代的推理内容，不能借机塞入细纲外的新信息。
2. **对信/对物自语转独立引号句**：把角色对着关键物件（信件、契约、账本）的心理活动，改写成他低声读出来或自问自答的独立引号句（"这是谁的旧事？"），比嵌在长叙述句里的心理陈述更有画面感，也能被 `check-ai-patterns.js` 的对话密度统计正确计入。这个技法本质仍是独白，不是真正的双人交锋对话，能小幅垫高数字，但改变不了独角戏场景对话密度的结构性天花板——不要因为用了这个技法就误判本章已经达到多人对手戏的密度水平。

两个技法都只用于确实没有第二人物在场的细纲场景；如果细纲允许安排对手戏而只是没设计对话，应该优先在细纲阶段就排一场真正的双人交锋，而不是靠这两个技法在正文阶段补救。
