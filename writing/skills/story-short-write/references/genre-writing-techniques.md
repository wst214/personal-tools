...
1. **阶梯式背叛**：在升级节点逐层揭露更大的背叛（道德→经济→生命），普通章负责证据、关系或行动推进
2. **冷热对比法**：主角越冷，对方越歇斯底里，反差越大越爽
3. **双面人剥皮术**：先写表面好，再层层剥开真相（复制粘贴的关心模板）
4. **前世记忆穿插法**：在需要解释反常行为或改变当下选择时穿插前世回忆，不机械章章回忆
5. **审判式对话**：主角永远在提问、永远在审判、永远居高临下

### 结构创新技法

1. **超短章节制**：每章500-1000字，每章一个可见兑现或推进；小爆点放在升级节点，适合手机阅读
...
| 每章一次可见兑现/推进 | 新信息、行动、关系或资源发生变化 | 读完后状态不变 |
