...
连载留存的硬下限不是“每章都有反转 / 悬念 / 爆点”，而是每章完成三件事：

1. **兑现**：偿还一笔旧期待，或以进展、新信息、关系反馈、资源收益、情绪释放支付利息。
2. **变化**：目标 / 风险 / 信息 / 关系 / 资源 / 身份 / 情绪立场至少一项发生可指认变化。
3. **续接**：开启一个有意义的下一步推动力。它可以是问题，也可以是决定、行动、关系变化、阶段目标或情绪余势。

这就是“**收一个，开一个**”。低压、奖励、关系回收、信息整理章不必制造硬悬念；只要兑现、状态变化和下一步成立，就有连载价值。强反转、强危机和爆点应保留给开篇、升级、付费点、高潮前后等结构节点，并与弱—中—强章节错落。

以下情况判为伪推进：
- 只截断动作，不改变任何状态；
- 故意隐瞒角色自然知道的信息；
- 章尾夸大危机，下一章立刻撤回、解释成误会或切线逃债；
- 连续多章用同一种强钩子，刺激升级但兑现越来越少；
- 只开新问题、不偿还旧期待，期待债持续膨胀。
