export default {
  ...
  taskDetail: {
    ...
    // Batch Operations
    selectAll: 'Select All',
    selectAllModule: 'Select Current Module',
    ...
    moduleOther: 'Other',
    moduleLogin: 'Login',
    module3d: '3D Visualization',
    moduleStorm: 'Storm Monitoring',
    moduleWarn: 'Warning',
    ...
    moduleMini: 'Mobile',
    emptyModuleTitle: 'No cases in this module',
    emptyModuleHint: 'Switch modules or go back to All',
