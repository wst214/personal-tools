    ...
    <div class="card-container">
      <div class="filter-bar">
        ...
        <el-select
          ...
          clearable
        >
          <el-option :label="$t('execution.filterActive')" :value="true" />
          <el-option :label="$t('execution.filterClosed')" :value="false" />
        </el-select>
      ...
      <div class="table-wrap">
        <el-table
          ...
          <el-table-column prop="name" :label="$t('execution.planName')" width="240" show-overflow-tooltip>
            <template #default="scope">
              <el-link class="plan-name-link" type="primary" @click="viewPlan(scope.row.id)">
                {{ scope.row.name }}
              </el-link>
            </template>
          </el-table-column>
          <el-table-column prop="projects" :label="$t('execution.projects')" width="110" show-overflow-tooltip>
            <template #default="scope">
          ...
          <el-table-column prop="version" :label="$t('execution.version')" width="80" show-overflow-tooltip />
          <el-table-column prop="creator.username" :label="$t('execution.creator')" width="80" show-overflow-tooltip />
          <el-table-column :label="$t('execution.status')" width="72" align="center">
            <template #default="scope">
          ...
          <el-table-column prop="created_at" :label="$t('execution.createdAt')" width="110">
            <template #default="scope">
              {{ formatDate(scope.row.created_at) }}
            </template>
          </el-table-column>
          <el-table-column min-width="24" class-name="col-spacer" label="" />
          <el-table-column :label="$t('execution.actions')" width="150" align="right" class-name="action-col">
            <template #default="scope">
...
.plan-table :deep(.col-spacer .cell) {
  padding: 0 !important;
}
