    ...
    <div class="card-container">
      ...
      <div class="table-wrap">
        <el-table
          ...
          <el-table-column type="index" :label="$t('version.serialNumber')" width="52" :index="getSerialNumber" />
          <el-table-column prop="name" :label="$t('version.versionName')" width="110" show-overflow-tooltip>
          ...
          <el-table-column prop="projects" :label="$t('version.relatedProject')" width="110" show-overflow-tooltip>
            <template #default="{ row }">
              <div v-if="row.projects && row.projects.length > 0" class="project-tags">
                <el-tag
                  v-for="project in row.projects.slice(0, 1)"
                  :key="project.id"
                  size="small"
                  type="primary"
                  class="project-tag"
                ...
                <el-tag v-if="row.projects.length > 1" size="small" type="info" class="project-tag">
          ...
          <el-table-column prop="description" :label="$t('version.description')" min-width="160" show-overflow-tooltip />
          <el-table-column prop="testcases_count" :label="$t('version.testCaseCount')" width="80" align="center">
            <template #default="{ row }">
              <el-tag type="info" size="small">{{ row.testcases_count }}</el-tag>
            </template>
          </el-table-column>
          <el-table-column prop="created_by.username" :label="$t('version.creator')" width="80" show-overflow-tooltip />
          <el-table-column prop="created_at" :label="$t('version.createdAt')" width="110">
            <template #default="{ row }">
