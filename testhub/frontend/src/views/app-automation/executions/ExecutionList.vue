  ...
  <div class="execution-list">
    ...
    <el-card class="table-card" shadow="never">
      ...
      >
        ...
        <el-table-column prop="device_name" :label="$t('appAutomation.execution.device')" min-width="120" show-overflow-tooltip />
        ...
        <el-table-column :label="$t('appAutomation.execution.progress')" min-width="140">
          <template #default="{ row }">
            <el-progress
        ...
        <el-table-column :label="$t('appAutomation.execution.stepStats')" min-width="200">
          <template #default="{ row }">
        ...
        <el-table-column :label="$t('appAutomation.execution.duration')" min-width="80">
          <template #default="{ row }">
            {{ formatDuration(row.duration) }}
          </template>
        </el-table-column>
        <el-table-column prop="user_name" :label="$t('appAutomation.execution.executor')" min-width="90" show-overflow-tooltip />
        <el-table-column :label="$t('appAutomation.execution.startTime')" min-width="150">
          <template #default="{ row }">
            {{ formatDateTime(row.started_at) }}
          </template>
        </el-table-column>
        <el-table-column :label="$t('appAutomation.execution.endTime')" min-width="150">
          <template #default="{ row }">
