  ...
  <div class="dashboard-container">
    ...
    <div class="features-section">
      ...
      <div class="features-grid">
        ...
        <div class="feature-card">
          <div class="feature-icon"><el-icon><Platform /></el-icon></div>
        ...
        <div class="feature-card">
          <div class="feature-icon"><el-icon><Bell /></el-icon></div>
        ...
        <div class="feature-card">
          <div class="feature-icon"><el-icon><Edit /></el-icon></div>
...
.stat-icon.bg-blue { background-color: #409eff; }
.stat-icon.bg-green { background-color: #67c23a; }
.stat-icon.bg-purple { background-color: #909399; }
.stat-icon.bg-orange { background-color: #e6a23c; color: #fff; }
.stat-icon.bg-red { background-color: #f56c6c; }
.stat-icon.bg-cyan { background-color: #13c2c2; }
.stat-icon.bg-indigo { background-color: #722ed1; }
...
.action-icon.bg-blue { background-color: #409eff; }
.action-icon.bg-green { background-color: #67c23a; }
.action-icon.bg-cyan { background-color: #13c2c2; }
.action-icon.bg-purple { background-color: #909399; }
.action-icon.bg-orange { background-color: #e6a23c; }
.action-icon.bg-indigo { background-color: #722ed1; }
.action-icon.bg-red { background-color: #f56c6c; }
