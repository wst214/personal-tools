<template>
  <div class="page-container">
    <div class="page-header">
      ...
      <el-select v-model="projectId" class="header-project" :placeholder="$t('uiAutomation.common.selectProject')" @change="onProjectChange">
    ...
    <div class="card-container">
      <div class="filter-bar">
        ...
        <el-select v-model="queryParams.status" class="filter-item" :placeholder="$t('uiAutomation.execution.statusFilter')" clearable>
        ...
        <el-select v-model="queryParams.browser" class="filter-item" :placeholder="$t('uiAutomation.execution.browserFilter')" clearable>
      ...
      <el-table :data="executions" v-loading="loading" style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="test_case_name" :label="$t('uiAutomation.execution.caseName')" min-width="160" show-overflow-tooltip>
        ...
        <el-table-column :label="$t('uiAutomation.execution.relatedObject')" min-width="90" align="center">
          <template #default="{ row }">
        ...
        <el-table-column prop="status" :label="$t('uiAutomation.execution.statusFilter')" min-width="90" align="center">
          <template #default="{ row }">
            <el-tag :type="getStatusType(row.status)" size="small">{{ getStatusText(row.status) }}</el-tag>
          </template>
        </el-table-column>
        <el-table-column prop="engine" :label="$t('uiAutomation.execution.testEngine')" min-width="100" align="center">
          <template #default="{ row }">
            {{ getEngineText(row.engine) }}
          </template>
        </el-table-column>
        <el-table-column prop="headless" :label="$t('uiAutomation.execution.executionMode')" min-width="90" align="center">
          <template #default="{ row }">
            {{ row.headless ? $t('uiAutomation.execution.headlessMode') : $t('uiAutomation.execution.headedMode') }}
          </template>
        </el-table-column>
        <el-table-column prop="browser" :label="$t('uiAutomation.execution.browserFilter')" min-width="90" align="center">
          <template #default="{ row }">
            {{ getBrowserText(row.browser) }}
          </template>
        </el-table-column>
        <el-table-column prop="created_by_name" :label="$t('uiAutomation.execution.executor')" min-width="90" align="center" show-overflow-tooltip />
        <el-table-column prop="started_at" :label="$t('uiAutomation.execution.startTime')" min-width="150" align="center">
          <template #default="{ row }">
            {{ formatDateTime(row.started_at) }}
          </template>
        </el-table-column>
        <el-table-column prop="finished_at" :label="$t('uiAutomation.execution.endTime')" min-width="150" align="center">
          <template #default="{ row }">
            {{ formatDateTime(row.finished_at) }}
          </template>
        </el-table-column>
        <el-table-column :label="$t('uiAutomation.execution.duration')" min-width="90" align="center">
          <template #default="{ row }">
            {{ formatDuration(row.execution_time) }}
          </template>
        </el-table-column>
        <el-table-column :label="$t('uiAutomation.common.operation')" min-width="160" fixed="right" align="center">
          <template #default="{ row }">
