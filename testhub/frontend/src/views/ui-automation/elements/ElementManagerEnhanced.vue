      ...
      <div class="sidebar">
        <div class="sidebar-header">
          ...
          <div class="header-actions">
            ...
            <el-button type="primary" size="small" @click="createEmptyElement" :title="$t('uiAutomation.element.addElement')">
...
.page-tree :deep(.el-tree-node.is-current > .el-tree-node__content) {
  background: #fff;
  box-shadow: 0 1px 2px rgba(20, 80, 60, 0.08);
  position: relative;
}

.page-tree :deep(.el-tree-node.is-current > .el-tree-node__content)::before {
  content: '';
  position: absolute;
  left: 0;
  top: 6px;
...
.context-menu {
  ...
  border: 1px solid #dcebe4;
  border-radius: 8px;
  box-shadow: 0 2px 12px 0 rgba(20, 80, 60, 0.12);
  padding: 5px 0;
  margin: 0;
  list-style: none;
  min-width: 120px;
