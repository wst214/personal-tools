<template>
  <div class="page-container scheduled-tasks">
    ...
    <div class="card-container">
      <div class="filter-bar">
        <el-select v-model="filters.task_type" class="filter-item" :placeholder="$t('uiAutomation.scheduledTask.taskType')" clearable>
        ...
        <el-select v-model="filters.trigger_type" class="filter-item" :placeholder="$t('uiAutomation.scheduledTask.triggerType')" clearable>
        ...
        <el-select v-model="filters.status" class="filter-item" :placeholder="$t('uiAutomation.scheduledTask.status')" clearable>
      ...
      <div class="table-scroll">
        <el-table :data="tasks" v-loading="loading" style="width: 100%">
          <el-table-column prop="name" :label="$t('uiAutomation.scheduledTask.taskName')" min-width="160" show-overflow-tooltip />
          <el-table-column prop="task_type" :label="$t('uiAutomation.scheduledTask.taskType')" min-width="100" align="center">
            <template #default="scope">
              <el-tag :type="scope.row.task_type === 'TEST_SUITE' ? 'success' : 'primary'" size="small">
          ...
          <el-table-column prop="notification_type_display" :label="$t('uiAutomation.scheduledTask.notificationType')" min-width="110" align="center">
            <template #default="scope">
          ...
          <el-table-column prop="trigger_type" :label="$t('uiAutomation.scheduledTask.triggerType')" min-width="100" align="center">
            <template #default="scope">
              <el-tag size="small">
          ...
          <el-table-column prop="status" :label="$t('uiAutomation.scheduledTask.status')" min-width="90" align="center">
            <template #default="scope">
              <el-tag size="small" :type="scope.row.status === 'ACTIVE' ? 'success' : scope.row.status === 'PAUSED' ? 'warning' : 'info'">
                {{ getStatusText(scope.row.status) }}
              </el-tag>
            </template>
          </el-table-column>
          <el-table-column prop="engine" :label="$t('uiAutomation.scheduledTask.executionEngine')" min-width="100" align="center">
            <template #default="scope">
          ...
          <el-table-column prop="browser" :label="$t('uiAutomation.scheduledTask.browser')" min-width="90" align="center">
            <template #default="scope">
              {{ scope.row.browser || 'chrome' }}
            </template>
          </el-table-column>
          <el-table-column prop="next_run_time" :label="$t('uiAutomation.scheduledTask.nextRunTime')" min-width="150" align="center">
            <template #default="scope">
              {{ formatDateTime(scope.row.next_run_time) }}
            </template>
          </el-table-column>
          <el-table-column prop="last_run_time" :label="$t('uiAutomation.scheduledTask.lastRunTime')" min-width="150" align="center">
            <template #default="scope">
              {{ formatDateTime(scope.row.last_run_time) }}
            </template>
          </el-table-column>
          <el-table-column :label="$t('uiAutomation.common.operation')" min-width="180" fixed="right" align="center">
            <template #default="scope">
