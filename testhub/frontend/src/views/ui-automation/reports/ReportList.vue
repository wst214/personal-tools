<template>
  <div class="page-container report-view">
    ...
    <div class="card-container">
      <div class="table-scroll">
        <el-table :data="reports" v-loading="loading" style="width: 100%">
          ...
          <el-table-column prop="test_suite_name" :label="$t('uiAutomation.report.testSuite')" min-width="160" show-overflow-tooltip />
          <el-table-column prop="status" :label="$t('uiAutomation.common.status')" min-width="100" align="center">
          ...
          <el-table-column :label="$t('uiAutomation.report.testEngine')" min-width="100" align="center">
            <template #default="{ row }">
              <el-tag size="small">{{ getEngineText(row.engine) }}</el-tag>
            </template>
          </el-table-column>
          <el-table-column :label="$t('uiAutomation.report.browser')" min-width="90" align="center">
            <template #default="{ row }">
              {{ getBrowserText(row.browser) }}
            </template>
          </el-table-column>
          <el-table-column prop="total_cases" :label="$t('uiAutomation.report.totalCases')" min-width="90" align="center" />
          <el-table-column prop="passed_cases" :label="$t('uiAutomation.report.passedCases')" min-width="80" align="center">
            <template #default="{ row }">
              <span style="color: #67c23a; font-weight: bold;">{{ row.passed_cases }}</span>
            </template>
          </el-table-column>
          <el-table-column prop="failed_cases" :label="$t('uiAutomation.report.failedCases')" min-width="80" align="center">
            <template #default="{ row }">
              <span style="color: #f56c6c; font-weight: bold;">{{ row.failed_cases }}</span>
            </template>
          </el-table-column>
          <el-table-column :label="$t('uiAutomation.report.passRate')" min-width="110" align="center">
            <template #default="{ row }">
              <el-progress
          ...
          <el-table-column :label="$t('uiAutomation.report.duration')" min-width="100" align="center">
            <template #default="{ row }">
              {{ formatDuration(row.duration) }}
            </template>
          </el-table-column>
          <el-table-column prop="executed_by_name" :label="$t('uiAutomation.report.executor')" min-width="90" align="center" show-overflow-tooltip />
          <el-table-column prop="created_at" :label="$t('uiAutomation.report.executionTime')" min-width="150" align="center">
            <template #default="{ row }">
