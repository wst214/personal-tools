          ...
          <div v-for="config in configs" :key="config.id" class="config-card">
            <div class="config-header">
              ...
              <div class="config-actions">
                ...
                <button type="button" class="edit-btn" @click="editConfig(config)" :title="$t('configuration.common.edit')">✎</button>
                <button type="button" class="delete-btn" @click="deleteConfig(config.id)" :title="$t('configuration.common.delete')">✕</button>
              </div>
            </div>
